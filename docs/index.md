...
!!! note "How to use this site"
    ...
    - **Left sidebar** — once you're inside a unit, this lists every
      lesson in that unit
    - **Right sidebar** — a section index for the page you're on,
      linking to each heading so you can jump around within a lesson

    Submit your work as instructed in D2L.
